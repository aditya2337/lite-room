...
Checklist:
- [ ] Configure filesystem MCP with workspace root `/Users/aditya/workspace/lite-room`.
...
- [ ] Add a section in `/Users/aditya/workspace/lite-room/README.md` linking this checklist.
- [ ] Create GitHub labels: `perf`, `rendering`, `catalog`, `export`, `bug`, `milestone`.
- [ ] Create milestone issues aligned to `/Users/aditya/workspace/lite-room/BUILD_PLAN.md`.
