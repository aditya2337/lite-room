...
## `domain`
Path:
- [/lite-room/crates/domain/src](/lite-room/crates/domain/src)
...
- [/lite-room/crates/application/src/use_cases.rs](/lite-room/crates/application/src/use_cases.rs)
...
## `adapters`
Path:
- [/lite-room/crates/adapters/src](/lite-room/crates/adapters/src)
...
## `drivers`
Path:
- [/lite-room/crates/drivers/src](/lite-room/crates/drivers/src)
